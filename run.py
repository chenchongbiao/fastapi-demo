...
from demo import app1,app04,app05,app06,app07,app08
...
app = FastAPI(
    ...
    description='FastAPI教程 新冠病毒疫情跟踪器API接口文档，项目代码：https://github.com/liaogx/fastapi-tutorial.git',
    version='1.0.0',
...
app.include_router(app1, prefix='/chapter03', tags=['第三章 请求参数和验证'])
